...
export default function Modal({ onToggleModal }) {
  ...
  return (
    <div className="w-screen h-screen top-0 left-0 bottom-0 right-0 fixed z-50 bg-[rgba(0,0,0,0.6)]">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white py-4 px-7 rounded-xl min-w-96 lg:min-w-[500px]">
        ...
        <form className="flex flex-col gap-2">
          ...
          <textarea className="w-full min-h-60 border border-slate-200 outline-none p-1 rounded focus:ring-1 focus:ring-primary" />
          <Button
            type="submit"
