...
describe('threadDetailReducer function', () => {
    ...
    const action = {
      ...
      payload: {
        threadDetail: {
          ...
          downVotesBy: [],
          comments: [],
          created: '2022-09-22T10:06:55.588Z',
        },
      },
    };
  ...
  it('should should return the thread detail without toggled UpVote and DownVote when given by NEUTRALIZE_VOTE_THREAD_DETAIL action', () => {
    // arrange
    const initialState = {
      id: 'thread-1',
      title: 'Thread Satu',
